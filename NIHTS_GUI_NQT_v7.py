""" NIHTS GUI - NIHTS Exposure Control
    v1.7: 2018-07-17, ag765@nau.edu, A Gustafsson
...
class NIHTSWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        def run_NIHTS_Arcs(self):
            infoBox = QMessageBox()
            infoBox.setText("Ask the TO to move the dichroic position to 237.9mm ... Ready?")
            ...
            if result == QMessageBox.Yes:
                ...
                print('need to include wait statement here')
                ...
                print("Ask the TO to move the dichroic position to 237.9mm and try again.")
    ...
    def run_NIHTS_Focus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            cs.move_object_on_xcam(tcs.current_target_pt, tcs.current_target_pt + wx.RealPoint(+50,0))
            ...
            nom_focus_sdssr = 650 #Nominal is 650 AG 08/10/18 with M1 = 0 (1650 for M1 = -1000)
            nom_focus = nom_focus_sdssr - 180
            tcs.send_focus_microns(nom_focus)
            print('--- Nominal Focus value is 830 microns ---')
