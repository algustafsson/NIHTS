...
class NIHTSWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        grid_t6.addWidget(CurrLMIXPos, 3, 1, 1, 1)
        grid_t6.addWidget(CurrLMIXPosEdit, 3, 2, 1, 1)
        grid_t6.addWidget(CurrLMIYPos, 3, 3, 1, 1)
        grid_t6.addWidget(CurrLMIYPosEdit, 3, 4, 1, 1)
        grid_t6.addWidget(DesLMIXPos, 5, 1, 1, 1)
        grid_t6.addWidget(DesLMIXPosEdit, 5, 2, 1, 1)
        grid_t6.addWidget(DesLMIYPos, 5, 3, 1, 1)
        grid_t6.addWidget(DesLMIYPosEdit, 5, 4, 1, 1)
