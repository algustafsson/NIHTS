""" NIHTS GUI - NIHTS Exposure Control
    v1.5: 2018-06-18, ag765@nau.edu, A Gustafsson
...
class NIHTSWidget(QWidget):
        ...
        def run_NIHTS_XFExp(self):
            ...
            """ XCAM Exposure - Take XCAM Exposure
                ...
                ** GUI Version - Needs Testing
                ...
                """
            x.go(3, 1, 1, return_images=False)
    ...
    def DarksStatus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            slits = []
            for i in range(9):
                status = bool(int(slit_states[i].split()[0][0]))
                if i == 0 and status == True:
                    slits.append(slitnames[i])
                elif i != 0 and bool(int(slit_states[0].split()[0][0])) == False:
                    status = bool(int(slit_states[i].split()[0][0]))
                    if status == True:
                        slits.append(slitnames[i])
        ...
        if result == QMessageBox.Yes:
            ...
            """ NIHTS FOCUS - Runs a focus script.
                ...
                ** GUI Version -- Needs Testing
                ...
                - be able to change exposure time
    ...
    def run_NIHTS_NTest(self):
        ...
        """ NIHTS Test - Take NIHTS Test Exposure
            ...
            ** GUI Version - Needs Testing
            ...
            updates:
            - need to get slit position information
        ...
        nihts.go(nexp=1, exptime=n_exptime, target='test', frame_type='object',  comment1 = 'Slit: '+slit+', Position: None', aborterror=False)
        ...
        if result == QMessageBox.Yes:
            ...
            """ NIHTS AB - Performs 1 AB sequence of images.
                ...
                ** GUI Version - Needs Testing
                ...
                updates:
                - test guiding
                - add in question to verify target is at a position
                """
        ...
        if result == QMessageBox.Yes:
            ...
            """ NIHTS CenSky - Performs Cen - Off slit sequence of images.
                ...
                ** GUI Version - Needs testing
                ...
                - Make all offsets in arcseconds, just do the calculation
                - Fix these directions with the arcsecond distances so it is consistent
                - test guiding
                - put in precaution question about target at center
