""" NIHTS GUI - NIHTS Exposure Control
    v1.9: 2018-08-17, ag765@nau.edu, A Gustafsson
    ...
    ** CURRENT NIHTS VERSION
    ...
    updates:
    - Focus script -- if no convergence is found, then use one of the minimum values
    ...
    def __init__(self, parent):
        ...
        def run_NIHTS_Arcs(self):
            ...
            if result == QMessageBox.Yes:
                ...
                nihts.go(nexp=5, exptime=20, target='Comparison', frame_type='comparison', comment1='Slit: None, Position: None', aborterror=False)
                nihts.wait4nihts()
