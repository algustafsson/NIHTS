""" NIHTS GUI - NIHTS Exposure Control
    v1.4: 2018-06-04, ag765@nau.edu, A Gustafsson
    
    Creating GUI to avoid scripting. Using PyQt5.
    
    Tries to call individual scripts when buttons are pushed. issue with global variables and functions.
...
class NIHTSWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        def run_NIHTS_Arcs(self):
            ...
            import NIHTS_arcs_v3
            NIHTS_arcs_v3.NIHTSArcs()
        ...
        grid_t2.addWidget(ArcsButton, 2, 2, 1, 2)
    ...
    def run_NIHTS_Terminal(self):
        import NIHTS_Terminal
        NIHTS_Terminal.NIHTSTerminal()
    ...
    def DarksStatus(self):
        infoBox = QMessageBox()
        infoBox.setText("Are the Dome Flat Lamps OFF?")
        ...
        if result == QMessageBox.Yes:
            ...
            import NIHTS_flats_darks_v7
            NIHTS_flats_darks_v7.NIHTSFlatsDarks(slit0,slit1,slit2,slit3,slit4,slit5,slit6,slit7,slit8)
    ...
    def FlatsStatus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            import NIHTS_flats_lamps_v7
            NIHTS_flats_lamps_v7.NIHTSFlatsLamps(slit0,slit1,slit2,slit3,slit4,slit5,slit6,slit7,slit8)
    ...
    def run_NIHTS_Focus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            import NIHTS_Focus_v8
            NIHTS_Focus_v8.NIHTSFocus(x_starpos,y_starpos,focus_filter,focus_step)
    ...
    def run_NIHTS_Move(self):
        ...
        import NIHTS_Move
        NIHTS_Move.NIHTSMove(current_slit,current_slit_pos)
    ...
    def run_NIHTS_XExp(self):
        ...
        import NIHTS_XExp
        NIHTS_XExp.NIHTSXExp(current_xexptime,current_coadds)
    ...
    def run_NIHTS_NTest(self):
        ...
        import NIHTS_NTest
        NIHTS_NTest.NIHTSNTest(current_slit,current_nexptime,current_guiding)
    ...
    def run_NIHTS_NExp(self):
        ...
        import NIHTS_NExp
        NIHTS_NExp.NIHTSNExp(current_target,current_slit,current_nexptime,current_guiding)
    ...
    def run_NIHTS_AB(self):
        ...
        if result == QMessageBox.Yes:
            ...
            import NIHTS_AB_v4
            NIHTS_AB_v4.NIHTSAB(current_target,current_slit,current_nexptime,current_xexptime,current_nnseq,current_guiding)
    ...
    def run_NIHTS_ABBA(self):
        ...
        if result == QMessageBox.Yes:
            ...
            logging.info('AB Parameters: %s: %s second(s): %s sequence(s): GDR %s' %(current_target, current_nexptime, current_nnseq, current_guiding))
            import NIHTS_ABBA_v10
            NIHTS_ABBA_v10.NIHTSABBA(current_target,current_slit,current_nexptime,current_xexptime,current_nnseq,current_guiding)
    ...
    def run_NIHTS_CenSky(self):
        ...
        if result == QMessageBox.Yes:
            ...
            import NIHTS_CenSky_v3
            NIHTS_CenSky_v3.NIHTSCenSky(current_target,current_slit,current_nexptime,current_xexptime,current_nnseq,current_offset,current_direction,current_guiding)
