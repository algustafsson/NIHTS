""" NIHTS GUI - NIHTS Exposure Control
    v1.6: 2018-06-18, ag765@nau.edu, A Gustafsson
    ...
    ** OLD NIHTS VERSION
    ...
    updates:
    - WHY can I not run the darks script?? Won't do the image, even though I can do tests just fine.
    - capability to change center of focus script
    ...
    - * set up logging so that it goes in the correct data folder --> needs testing
...
class NIHTSWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        def run_NIHTS_Arcs(self):
            ...
            # Which status bar is better to use???
            #nihts.go(nexp=5, exptime=120, target='Comparison', frame_type='comparison', comment1='Slit: None, Position: None', aborterror=False)
            
            completed = 0
            nihts.go(nexp=1, exptime=120, target='Comparison', frame_type='comparison', comment1='Slit: None, Position: None', aborterror=False)
            nihts.wait4nihts()
            completed = 16.6667
        ...
        grid_t2.addWidget(Progress_t2, 7, 1, 1, 3)
        ...
        ExposureTimeEdit = QSpinBox() #(self)
        ...
        grid_t3.addWidget(Progress_t3, 6, 1, 1, 3)
        ...
        grid_t5.addWidget(Progress_t5, 7, 1, 1, 3)
    ...
    def run_NIHTS_Terminal(self):
        ...
        """ GUI Terminal Line - Enter Commands on Terminal Line
            ...
            ** GUI Version - Needs Testing
            ...
            """
        print('this will do terminal things...')
    ...
    def run_NIHTS_Focus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            """ NIHTS FOCUS - Runs a focus script.
                v1.8: 2018-05-14, ag765@nau.edu, A Gustafsson
                ...
                ** GUI Version -- Needs Testing
                ...
                - be able to change exposure time -- TEST
            ...
            focus_filt = int(focus_filter)
            x_exptime = float(xtime)
            step = float(focus_step)
            seeing = 2
    
            filter_list = ['OPEN','B','V','R','VR','SDSSg','SDSSr','SDSSi','OIII','Ha_on','Ha_off','WC','WN','CT','BC','GC','RC']
            filter = filter_list[focus_filt]
    ...
    def run_NIHTS_Move(self):
        ...
        slit = slit_list[int(curr_slit)]
        pos = pos_list[int(curr_slit_pos)]
    
        tcs.move_to_slit_position(tcs.slit[slit][pos])
    ...
    def run_NIHTS_AB(self):
        ...
        if result == QMessageBox.Yes:
            ...
            for i in range(nseq):
                ...
                x.go(x_exptime,x_coadds,1,return_images=True)
    ...
    def run_NIHTS_CenSky(self):
        ...
        if result == QMessageBox.Yes:
            ...
            if direction != 5 and direction != 6:
