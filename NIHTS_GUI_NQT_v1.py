""" NIHTS GUI - NIHTS Exposure Control
    v1.1: 2018-05-30, ag765@nau.edu, A Gustafsson
...
class NIHTSWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        def run_NIHTS_XFExp(self):
            os.system('python /Users/user/xcam/NIHTS_XFExp.py')
        ...
        CenOffButton.clicked.connect(self.run_NIHTS_CenOff)
    ...
    def run_NIHTS_Terminal(self):
        os.system('python /Users/user/xcam/NIHTS_Terminal.py')
    ...
    def DarksStatus(self):
        infoBox = QMessageBox()
        infoBox.setText("Are the Deveny 6V Dome Flat Lamps OFF?")
        ...
        if result == QMessageBox.Yes:
            ...
            os.system('python /Users/user/xcam/NIHTS_flats_darks_v6.py %s' % ', '.join(map(str, slit_state)))
        else:
            print('Turn the Deveny 6V Dome Lamps OFF and try again.')
    
    global FlatsStatus
    def FlatsStatus(self):
        infoBox = QMessageBox()
        infoBox.setText("Are the Deveny 6V Dome Flat Lamps ON?")
        ...
        if result == QMessageBox.Yes:
            ...
            slit_state = [state_0[-1], state_1[-1], state_2[-1], state_3[-1], state_4[-1], state_5[-1], state_6[-1], state_7[-1], state_8[-1]]
            os.system('python /Users/user/xcam/NIHTS_flats_lamps_v6.py %s' % ', '.join(map(str, slit_state)))
        else:
            print('Turn the Deveny 6V Dome Lamps ON and try again.')
    ...
    def run_NIHTS_Focus(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_Focus_v8.py %s %s %s %s' % (x_starpos, y_starpos, focus_filter, focus_step))
    ...
    def run_NIHTS_Move(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_Move.py %s %s' % (current_slit, current_slit_pos))
    ...
    def run_NIHTS_NTest(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_NTest.py %s %s %s' % (current_slit, current_nexptime, current_guiding))
    ...
    def run_NIHTS_NExp(self):
        ...
        os.system('python /Users/user/xcam/NIHTS/NIHTS_NExp.py %s %s %s %s %s' % (current_target, current_nexptime, current_slit, current_slit_pos, current_guiding))
    ...
    def run_NIHTS_AB(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_AB_v4.py %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_xexptime, current_coadds, current_nnseq, current_guiding))
    ...
    def run_NIHTS_ABBA(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_ABBA_v10.py %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_xexptime, current_coadds, current_nnseq, current_guiding))
    ...
    def run_NIHTS_CenOff(self):
        ...
        os.system('python /Users/user/xcam/NIHTS_CenOff_v3.py %s %s %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_nnseq, current_xexptime, current_coadds, current_offset, current_direction, current_guiding))
