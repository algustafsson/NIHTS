""" NIHTS GUI - NIHTS Exposure Control
    v1.2: 2018-05-30, ag765@nau.edu, A Gustafsson
...
class NIHTSWidget(QWidget):
    ...
    def run_NIHTS_Terminal(self):
        os.system('python /Users/xcam/NIHTS_Terminal.py')
    ...
    def DarksStatus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            os.system('python /Users/xcam/NIHTS_flats_darks_v6.py %s' % ', '.join(map(str, slit_state)))
    ...
    def FlatsStatus(self):
        ...
        if result == QMessageBox.Yes:
            ...
            os.system('python /Users/xcam/NIHTS_flats_lamps_v6.py %s' % ', '.join(map(str, slit_state)))
            logging.info('Dome Darks Sequence Begin for slits: %s' %slits)
        else:
    ...
    def run_NIHTS_Focus(self):
        ...
        os.system('python /Users/xcam/NIHTS_Focus_v8.py %s %s %s %s' % (x_starpos, y_starpos, focus_filter, focus_step))
    ...
    def run_NIHTS_Move(self):
        ...
        os.system('python /Users/xcam/NIHTS_Move.py %s %s' % (current_slit, current_slit_pos))
    ...
    def run_NIHTS_XExp(self):
        ...
        os.system('python /Users/xcam/NIHTS_XExp.py %s %s' % (current_xexptime, current_coadds))
    ...
    def run_NIHTS_NTest(self):
        ...
        os.system('python /Users/xcam/NIHTS_NTest.py %s %s %s' % (current_slit, current_nexptime, current_guiding))
    ...
    def run_NIHTS_NExp(self):
        ...
        os.system('python /Users/xcam/NIHTS/NIHTS_NExp.py %s %s %s %s %s' % (current_target, current_nexptime, current_slit, current_slit_pos, current_guiding))
    ...
    def run_NIHTS_AB(self):
        ...
        os.system('python /Users/xcam/NIHTS_AB_v4.py %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_xexptime, current_coadds, current_nnseq, current_guiding))
    ...
    def run_NIHTS_ABBA(self):
        ...
        os.system('python /Users/xcam/NIHTS_ABBA_v10.py %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_xexptime, current_coadds, current_nnseq, current_guiding))
    ...
    def run_NIHTS_CenSky(self):
        ...
        os.system('python /Users/xcam/NIHTS_CenSky_v3.py %s %s %s %s %s %s %s %s %s' % (current_target, current_slit, current_nexptime, current_nnseq, current_xexptime, current_coadds, current_offset, current_direction, current_guiding))
